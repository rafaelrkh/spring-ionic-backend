...
public class ProdutoResource {
	...
	@RequestMapping(value="/{cdProduto}", method=RequestMethod.GET)
	public ResponseEntity<Produtos> find(@PathVariable Integer cdProduto) {	
		
		Produtos obj = service.find(cdProduto);
